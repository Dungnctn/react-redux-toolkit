                ...
                <div className="mt-2 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div className="mt-10">
                        <form onSubmit={handleSubmit(onsubmit)}>
                            <div>
                                <div className="text-sm font-bold text-gray-700 tracking-wide float-left">Tài khoản</div>
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" {...register("username")} type="text" required placeholder="Tên tài khoản" />
                            </div>
                            <div className="mt-8">
                                <div>
                        ...
                        <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Bạn đã có tài khoản ? <NavLink to={"/signin"} className="cursor-pointer text-indigo-600 hover:text-indigo-800">Đăng nhập</NavLink>
                        </div>
                    </div>
                </div>
            </div>
