...
const Cart = () => {
    ...
    const handlePayment = () => {
      console.log("payment", JSON.parse(localStorage.getItem("userToken")));
      
      if(JSON.parse(localStorage.getItem("userToken")) == null) {
        return (
          <div className='bg-cyan-600'>
            <span>Bạn cần đăng nhập để đặt hàng <NavLink to={'signin'}>Đăng nhập</NavLink> </span>
          </div>
        )
      } else {
        navigate("/checkout"); 
    ...
    if(cart.length === 0){
      return <div>
        ...
        <button className='button mx-auto'>
          <NavLink to={'/'}><span class='span'>BACK</span></NavLink>
        ...
        <div className="flex-1">
            ...
            {cart.cartItems.map(item => 
              <tr key={item._id0}>
                ...
                <td className="w-28 float-left mt-8">
                  <div className="w-20 h-10 ">
                    <div className="flex flex-row w-full h-8">
                      <Button type='danger' onClick={() => handleDecreaseCart(item)}>-</Button>
                      <input type="number" min={1} value={item.quantity} className="text-center w-20"/>
                      <Button type='primary' onClick={() => handleIncreaseCart(item)} >+</Button>
                    </div>
                  </div>
                </td>
                ...
                <td className='text-center'>
                  <Button type='danger' onClick={() => handleRemoveCart(item)}>{<DeleteFilled />}</Button>
                </td>
              </tr> 
            )}
            <Button type='danger' onClick={() => hanleClearCart()} >Xóa giỏ hàng</Button>
            </tbody>
          </table>
          ...
          <div className="my-4 mt-6 -mx-2 lg:flex">
            <div className="lg:px-2 lg:w-1/2">
                ...
                <div className="justify-center md:flex">
                  <form action="" method="POST">
                      <div className="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                        <input type="coupon" name="code" id="coupon" placeholder="Nhập mã giảm gái" value=""
              ...
              <div className="p-4">
                <p className="mb-4 italic">Nếu bạn có một số thông tin cho người bán, bạn có thể để lại chúng trong khung bên dưới</p>
            ...
            <div className="lg:px-2 lg:w-1/2">
              ...
              <div className="p-4">
                <p className="mb-6 italic">Chi phí vận chuyển và chi phí cộng thêm được tính dựa trên các giá trị bạn đã nhập</p>
                  <div className="flex justify-between border-b">
                    ...
                    <div className="flex justify-between pt-4 border-b">
                      ...
                      <div className="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-gray-900">
                        {(200000).toLocaleString("vn-VN")} <u>đ</u>
                      </div>
                    </div>
                    <div className="flex justify-between pt-4 border-b">
                      <div className="lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-center text-gray-800">
                      ...
                      <div className="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-gray-900">
                        {((cart.cartTotalAmout) - (cart.cartTotalAmout * 0.03) - (200000)).toLocaleString("vn-VN")} <u>đ</u>
                      </div>
                    </div>
                    <button onClick={handlePayment} className="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
